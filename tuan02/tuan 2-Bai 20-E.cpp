...
int main()
{
	...
	do
	{
	cout << "so gio lam viec cua thang "<<i<<": ";cin >> n;
	...
	int tientt = ttien-thue;	cout << "thu nhap sau thue cua sv cua thang "<< i<<": " << tientt <<endl;
	int tienkd = 1500000+tientt;
	int tientra = tienkd-2000000;
		int tiencuoithang = tiendauthang*1.02;
		if(tiendauthang<tientra) cout<<"khoan thanh toan cuoi cung voi ngan hang la: "<<tiendauthang<<endl;
	...
	cout << "so thang can de tra het la: " << i--;
	return 0;
